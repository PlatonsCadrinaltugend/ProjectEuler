...
fn main() {
    ...
    let contents = fs::read_to_string(r"C:\Users\Domin\OneDrive\Desktop\Studiumsstuff\Programmierung\Rust\ProjectEuler\euler042\0042_words.txt").expect("REASON").to_lowercase();
